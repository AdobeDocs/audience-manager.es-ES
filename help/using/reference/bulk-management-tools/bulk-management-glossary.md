...
<table id="table_2C2BC2FB3EFC443C9A5AE18EFC6FABFD"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Un ID pasado a un destino no basado en cookies. Para un destino basado en cookies, ésta es la clave de un par <a href="../../reference/key-value-pairs-explained.md"></a>clave-valor. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Clave de un par <a href="../../reference/key-value-pairs-explained.md"></a> clave-valor que se pasa a un destino de cookie. </p> </td> 
  </tr> 
 </tbody> 
</table>
