...
Esta página está destinada a los clientes de Audience Manager que utilizan el [Extensión de etiquetas de Audience Manager](https://experienceleague.adobe.com/en/docs/experience-platform/tags/extensions/client/audience-manager/overview) para llevar los datos de recopilación web a Audience Manager. Para los clientes que utilizan la biblioteca JavaScript de AppMeasurement de, lea la guía sobre cómo actualizar la biblioteca de recopilación de datos para Audience Manager [de la biblioteca JavaScript de AppMeasurement a la biblioteca JavaScript del SDK web](appmeasurement-to-web-sdk.md).
...
1. Asegúrese de que la **[!UICONTROL Enable XDM Flattened Fields]** La opción está desmarcada.
...
1. En el panel de navegación izquierdo de la propiedad de etiqueta, seleccione **[!UICONTROL Extensions]**.
1. Seleccionar **[!UICONTROL Catalog]** cerca de la parte superior para ver una lista de todas las extensiones disponibles.
1. Busque y seleccione el **[!UICONTROL Adobe Experience Platform Web SDK]** extensión y seleccione **[!UICONTROL Install]** en el lado derecho.

   ![Catálogo](assets/catalog.png) {style="border:1px solid lightslategray"}

1. Aparecerán los ajustes de configuración de la extensión. Busque el **[!UICONTROL Datastreams]** y seleccione la zona protegida que está utilizando y el conjunto de datos que ha creado en el paso anterior.
...
1. Cambie el [!UICONTROL Action Configuration] a la siguiente configuración:
   * **[!UICONTROL Extension]**: [!UICONTROL Adobe Experience Platform Web SDK]
   * **[!UICONTROL Action type]**: Actualizar variable
1. Asegúrese de que el objeto de datos que ha creado en el paso 3 esté seleccionado en la lista desplegable de la derecha, en la **[!UICONTROL Data element]** field.
...
1. Seleccionar **[!UICONTROL Keep Changes]**.
...
1. Seleccionar **[!UICONTROL Add Library]**.
1. Asigne un nombre a esta confirmación de etiqueta, como &quot;Actualizar al SDK web&quot;.
1. Seleccionar **[!UICONTROL Add All Changed Resources]**.
1. Seleccionar **[!UICONTROL Save]**.
...
1. Busque y seleccione el [!UICONTROL Audience Manager] extensión. A la derecha, seleccione **[!UICONTROL Disable]**.
1. Siga el mismo flujo de trabajo de publicación anterior para publicar la eliminación del [!UICONTROL Audience Manager] extensión.
