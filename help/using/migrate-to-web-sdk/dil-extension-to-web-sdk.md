---
title: Migración de la extensión de etiquetas de Audience Manager a la extensión de etiquetas de Web SDK
description: Conozca los pasos para actualizar la biblioteca de recopilación de datos para Audience Manager desde la extensión de etiquetas de Audience Manager a la extensión de etiquetas de Web SDK
...
# Actualice la biblioteca de recopilación de datos para Audience Manager desde la extensión de etiquetas de Audience Manager a la extensión de etiquetas de Web SDK

## Destinatarios previstos

Esta página está dirigida a los clientes de Audience Manager que utilizan la [extensión de etiquetas de Audience Manager](https://experienceleague.adobe.com/en/docs/experience-platform/tags/extensions/client/audience-manager/overview) para introducir datos de recopilación web en Audience Manager. Para los clientes que utilizan la biblioteca JavaScript de AppMeasurement, lea la guía sobre cómo actualizar la biblioteca de recopilación de datos para Audience Manager [de la biblioteca JavaScript de AppMeasurement a la biblioteca JavaScript de Web SDK](appmeasurement-to-web-sdk.md).
...
Siga las instrucciones siguientes para crear un conjunto de datos en la recopilación de datos de Adobe Experience Platform. Cuando envía datos a este conjunto de datos, estos se reenvían a Audience Manager. En el futuro, este mismo conjunto de datos reenviará datos a Real-Time CDP.
...
El conjunto de datos ya está listo para recibir y pasar datos a Audience Manager.
...
+++**4. Actualice las reglas para utilizar la extensión Web SDK en lugar de la extensión Audience Manager**

Este paso supone la mayor parte del esfuerzo necesario para migrar a Web SDK y requiere conocer el funcionamiento de la implementación. A continuación se proporciona un ejemplo de cómo editar una regla de etiqueta típica. Actualice todas las reglas de etiquetas de la implementación para reemplazar todas las referencias a la extensión de Audience Manager con la extensión de Web SDK.
...
1. Establezca los pares de clave-valor de Audience Manager en sus mismos valores respectivos que se configuraron en la extensión de Audience Manager.
1. Una vez replicada toda la lógica de reglas con la extensión Web SDK, seleccione **[!UICONTROL Keep Changes]**.
1. Repita estos pasos para cada configuración de acción que utilice la extensión de etiqueta de Audience Manager para establecer valores.
...
1. Seleccione una regla que envíe un evento de Web SDK.
...
Una vez que la implementación de etiquetas haya migrado completamente a Web SDK, puede desactivar la extensión de Audience Manager.
...
En este punto, la implementación de Audience Manager se migra completamente a Web SDK y está preparada para pasar a Real-Time CDP en el futuro.
