...
Los [!DNL API] métodos de descanso para administrar grupos, incluso crear, actualizar, enumerar y eliminar grupos.
...
## Lista de todos los permisos para un grupo {#list-permissions-group}
