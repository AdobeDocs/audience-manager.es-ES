---
description: Métodos que permiten trabajar de manera programática con Data Integration Library (DIL).
...
>[!IMPORTANT]
>
>La API de Data Integration Library se ha desaprobado. Esta API se usa para generar DIL, que ahora puede descargar aquí: [DIL download](https://github.com/Adobe-Marketing-Cloud/dil/releases).
