...
Lista y describe la sintaxis y los atributos admitidos (o pares de clave-valor) que puede pasar a [!UICONTROL Data Collection Servers] ([!UICONTROL DCS]). Esta información puede ayudarle a dar formato a sus [!UICONTROL DCS] solicitudes y a comprender los parámetros devueltos por este sistema.

## Prefijos de atributos {#attribute-prefixes}

El [!UICONTROL DCS] se basa en prefijos específicos agregados a las claves en pares clave-valor para clasificar el tipo de datos que está pasando.
...
<table id="table_23B7E15EC13749E9A245DFB543822DB7"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p><span class="keyword"> Atributos del Administrador</span> de Audiencias. </p> </td> 
  </tr> 
  <tr> 
...
Todas estas opciones son opcionales, a menos que desee una respuesta del [!UICONTROL DCS]. Si desea que el [!UICONTROL DCS] usuario devuelva una respuesta, entonces `d_rtbd=json` es necesario.
...
<table id="table_FCCE4F9D796648899772A191981EFDE6"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Contiene uno o más pares de ID de proveedores de datos (<code> DPID</code>) e ID de usuarios de proveedores de datos (<code> DPUUID</code>) asignados por el Administrador <span class="keyword"> de</span>Audiencias. Si utiliza varios pares de <code> DPID</code>s y <code> DPUUID</code>s, separe cada par con el carácter no imprimible <code> %01</code>. Por ejemplo: <code><i>DPID</i>%01<i>DPUUUID</i></code>. </p> <p><code> d_cid</code> reemplaza <code> d_dpid</code> y <code> d_dpuuid</code>, que están en desuso pero siguen siendo compatibles. Consulte <a href="../../../reference/cid.md">CID sustituye DPID y DPUUID</a>. </p> </td>
  </tr>
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p><code> d_dst_filter</code> es un atributo reservado que se utiliza en la integración entre Adobe Analytics y el Administrador de Audiencias. </p> <p>Se recomienda no crear características que utilicen atributos reservados. Adobe puede cambiar los atributos reservados en cualquier momento. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Permite al Administrador de Audiencias distinguir las solicitudes móviles de las solicitudes de escritorio. Los valores admitidos son: </p> <p> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Obsoleta. <code> d_rs</code> es un atributo reservado que se utiliza en la integración heredada entre <span class="keyword"> Adobe Analytics</span> y <span class="keyword"> Audiencia Manager</span>. </p> <p>Se recomienda no crear características que utilicen atributos reservados. Adobe puede cambiar los atributos reservados en cualquier momento. </p> </td> 
  </tr> 
  <tr> 
