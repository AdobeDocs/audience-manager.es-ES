...
seo-description: Enumera y describe la sintaxis y los atributos admitidos (o pares clave-valor) que puede pasar a los Servidores de recopilación de datos (DCS). Esta información puede ayudarle a dar formato a sus solicitudes de DCS y a comprender los parámetros devueltos por este sistema.
...
Enumera y describe la sintaxis y los atributos admitidos (o pares de clave-valor) que puede pasar a [!UICONTROL Data Collection Servers] ([!UICONTROL DCS]). Esta información puede ayudarle a dar formato a sus [!UICONTROL DCS] solicitudes y a comprender los parámetros devueltos por este sistema.
...
<table id="table_FCCE4F9D796648899772A191981EFDE6"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Especifica el ID de Experience Cloud definido y utilizado por el servicio de ID de <span class="keyword"> Experience Cloud</span> . For more information about the ECID, see <a href="https://marketing.adobe.com/resources/help/en_US/mcvid/?f=mcvid_cookies.html" format="https" scope="external"> Cookies and the Experience Cloud ID</a>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><code> d_nsid</code> </p> </td> 
   <td colname="col2"> <p>Nombre del ID del espacio. Indica qué contenedor JavaScript se utiliza. Utilizado por <span class="wintitle"> DIL</span> para la sincronización de ID. </p> </td> 
  </tr> 
  <tr> 
