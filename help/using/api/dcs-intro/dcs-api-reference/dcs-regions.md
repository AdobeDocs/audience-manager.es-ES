...
También puede utilizar [!DNL API] métodos para obtener una lista de las [!DNL DCS] regiones disponibles. See [DCS Region API Methods](../../../api/rest-api-main/aam-api-dcs-regions.md).