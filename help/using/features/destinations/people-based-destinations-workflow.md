...
**A) Segmentación de audiencias en función de las direcciones** de correo electrónico autenticadas. En este escenario, los usuarios tienen varias cuentas asociadas con varias direcciones de correo electrónico y desea segmentar con ofertas personalizadas, basadas únicamente en la dirección de correo electrónico que autentican en el sitio web, en tiempo real.
