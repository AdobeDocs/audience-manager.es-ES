...
## Calificaciones de segmentos de Audience Manager en Adobe Analytics {#segment-qualifications}
...
La sección Configuración enumera los grupos de informes de Analytics que se han habilitado para el reenvío del lado del servidor. Si tiene varios destinos de Analytics, los grupos de informes asignados a estos destinos se excluirán mutuamente y Audience Manager los aplicará. Para completar esta sección:
