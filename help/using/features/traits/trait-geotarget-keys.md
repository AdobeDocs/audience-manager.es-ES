---
description: Describe los pares clave-valor comunes a nivel de plataforma que puede usar para dirigirse a usuarios con variables geográficas en todas las propiedades de la cuenta de Audience Manager.
