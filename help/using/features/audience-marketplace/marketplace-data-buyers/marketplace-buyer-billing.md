...
Los compradores de datos de Audience Marketplace aceptan informar de todas las impresiones de publicidad servidas mediante las características incluidas en la fuente de datos con un precio de coste por cada mil impresiones de publicidad ([!DNL CPM]). El uso de [!DNL CPM] vence el quinto día de cada mes calendario e incluye datos del mes anterior. Los suscriptores de tarifa plana no necesitan informar sobre el uso.
...
* **Informes a nivel de fuente de datos**: este método requiere que informe individualmente del uso de [!DNL CPM] para cada fuente de datos, en función de los algoritmos descritos en [Atribución de costos para fuentes de datos de CPM](#cost-attribution). Sin embargo, este método es más tedioso y propenso a errores que los informes de nivel de segmento.

<br> 

## Uso de Report CPM en el nivel de segmento {#segment-level-report}
...
Los informes de nivel de fuente de datos son un proceso más tedioso y propenso a errores, ya que debe calcular individualmente el uso de [!DNL CPM] para cada fuente de datos. En su lugar, le recomendamos que [Informe del uso de CPM en el nivel de segmento](#segment-level-report).
...
5. Calcule el uso de [!DNL CPM] para cada fuente de datos en función de [Atribución de costos para fuentes de datos de CPM](#cost-attribution) y escríbalo en la columna [!UICONTROL Usage].
...
<table id="table_E68FA2130D1C495FAB8982DFB6A31FD9"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Para totales de impresiones de CPM: </p>
   <p> Notificar el número total de impresiones, sin utilizar decimales. Audience Manager calcula automáticamente la CPM en función del número total que notifique.</p><p>Si necesita informar de 1.234.567 impresiones, informe exactamente de esa manera. No es necesario dividir el número total de impresiones entre 1000 para calcular la CPM.</p><p>Las características utilizadas para optimizar el contenido de su aplicación o web (optimización de contenido) mediante herramientas como Adobe Target o un destino de Analytics no contribuyen a los totales de uso de los planes de CPM. Los proveedores de datos suelen recibir una compensación por la optimización de contenido mediante planes de tarifas fijas.</p><p>Consulte <a href="#cost-attribution">Atribución de costes para fuentes de datos de CPM</a> para obtener más información. </p> </td>
  </tr>
  <tr> 
   <td colname="col1"> <p><b>Respetar el intervalo de informe mensual</b> </p> </td> 
   <td colname="col2"> <p>El sistema de informes se cierra a partir del 5 de cada mes. Si para entonces no ha podido informar sobre el uso de CPM, debe añadir esa cantidad al informe del mes siguiente. Por ejemplo, supongamos que utiliza 1000 impresiones en octubre, que se pierde la fecha límite de informes de octubre y que utiliza 1000 impresiones en noviembre. En este caso, se informa del total de octubre y noviembre (2000) en diciembre, entre el 1 y el 5.</p><p><b>Sugerencia</b>: Siempre debe intentar informar sobre el uso de CPM en el mes anterior entre el primer y el quinto día del mes siguiente.</p><p>Puede realizar informes sobre el uso de CPM hasta el día 5 del nuevo mes natural, pero no es recomendable. Al informar sobre el uso de CPM antes del 5 de cada mes, Audience Manager tiene tiempo de comprobar y procesar los datos.</p> </td>
  </tr> 
 </tbody> 
</table>
...
>[!TIP]
>[Informe de uso de CPM en el nivel de segmento](#segment-level-report) para que Audience Manager realice automáticamente los informes de nivel de fuente de datos.
