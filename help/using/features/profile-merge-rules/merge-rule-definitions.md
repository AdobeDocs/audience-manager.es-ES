...
| Últimos perfiles autenticados | Gráfico de dispositivo de vínculo de perfil | Todos los clientes | Tiempo real y lote | Sí | [Targeting entre dispositivos](profile-link-use-case.md#cross-device-personalization) |
...
Los segmentos de audiencia que se crearon automáticamente a partir de otras soluciones de Experience Cloud, en función de reglas de combinación definidas fuera de Audience Manager, se marcan como si utilizaran un [!UICONTROL External Merge Policy]. Por ejemplo, consulte Uso compartido [de público entre Audience Manager y Adobe Experience Platform](../../integration/integration-aep/aam-aep-audience-sharing.md).
