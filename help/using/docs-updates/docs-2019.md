...
| Tema | Descripción |
|--- |----|
| [Revisión general de la documentación de privacidad y soporte de la Ley de Privacidad del Consumidor de California (CCPA)](../overview/data-security-and-privacy/data-privacy.md) | El [California Consumer Privacy Act (CCPA)](https://www.caprivacy.org/about), que entrará en vigor el 1 de enero de 2020, otorgará a los residentes de California nuevos derechos con respecto a su información personal e impondrá responsabilidades de protección de datos a ciertas entidades que operen en California. <br> <br> Audience Manager le ayuda a cumplir con sus obligaciones en virtud de las normas de privacidad, a través de herramientas de privacidad como [Adobe Experience Platform Privacy Service](https://docs.adobe.com/content/help/es-ES/experience-platform/privacy/home.html) para solicitudes de acceso a datos y eliminación. <br><br> Hemos actualizado el actual [administración de exclusión](../overview/data-security-and-privacy/data-privacy-requests.md#opt-out-requests) proceso para incluir la exclusión de cualquier ID declarado (por ejemplo, ID de CRM). En caso de exclusión por ID declarado, el ID declarado y el último dispositivo vinculado se excluirán de la recopilación de datos del Audience Manager. Las solicitudes de exclusión ahora también envían solicitudes de eliminación de la segmentación a [socios de destino](../overview/data-security-and-privacy/assets/AAM-Partners-October2019.xlsx) que admiten esta función, tanto en lote como en tiempo real. <br><br> Además, hemos rediseñado nuestros [Seguridad de datos](../overview/data-security-and-privacy/data-security.md), [Privacidad de datos](../overview/data-security-and-privacy/data-privacy.md), y [Gobernanza de datos](../overview/data-security-and-privacy/data-governance.md) documentación, para facilitarle la búsqueda de la información necesaria para cumplir con la normativa mencionada. |

## Octubre de 2019 {#aam-october-updates}

| Tema | Descripción |
|--- |----|
| [Recomendaciones inteligentes para datos de Audience Marketplace, con tecnología de Adobe Sensei](../features/segments/trait-recommendations.md) | Con Trait Recommendations, cuando crea o edita un segmento en [Generador de segmentos](../features/segments/segment-builder.md)Ahora, obtiene recomendaciones sobre características adicionales que puede incluir, desde [!UICONTROL Audience Marketplace] fuentes de datos a las que no está suscrito. Añada las características recomendadas al segmento para aumentar la audiencia objetivo. <br>  Además, hemos rediseñado el [!UICONTROL Marketplace] para facilitar la búsqueda de características similares y el filtrado de fuentes de datos. |
...
| Tema | Descripción |
|--- |----|
| [HTTP Strict-Transport-Security](../overview/data-security-and-privacy/data-security.md#hsts) | Se ha agregado compatibilidad con [!DNL HTTP Strict-Transport-Security], una política de seguridad web que protege contra el secuestro de cookies y los ataques de reducción de categoría de protocolos. |
...
| <ul><li>[Generador de segmentos](/help/using/features/segments/segment-builder.md)</li><li>[Creación de informes de nivel de segmento en Audience Marketplace](/help/using/features/audience-marketplace/marketplace-data-buyers/marketplace-buyer-billing.md)</li><li>[Informes de identidad de audiencia en la vista Resumen de características ](/help/using/features/traits/trait-details-page.md)</li><li>[Informes de identidad de Audiencia en la vista Resumen de segmentos ](/help/using/features/segments/segment-summary-view.md)</li><li>[Cómo crear rasgos de conversión](/help/using/features/traits/create-onboarded-rule-based-traits.md)</li><li>[Recomendaciones de rasgos](/help/using/features/segments/trait-recommendations.md)</li></ul> | Hemos añadido vídeos de tutoriales a varias páginas en la documentación del Audience Manager. |

## Agosto de 2019 {#aam-august-updates}

| Tema | Descripción |
|--- |----|
| [People-Based Destinations](../features/destinations/people-based-destinations-overview.md) | People-Based Destinations es un complemento de pago para Audience Manager que ayuda a activar segmentos de audiencia propios en entornos basados en personas, como Facebook, usando identificadores hash, como direcciones de correo electrónico. |
| [Configuración de las audiencias personalizadas de Twitter como destino basado en dispositivos de autoservicio](../features/destinations/twitter-tailored-audiences.md) | Estamos migrando destinos de Twitter a un modelo de configuración de autoservicio. En este artículo se explica lo que debe hacer para que las integraciones de Twitter existentes sigan funcionando después de la migración. |
...
| Tema | Descripción |
|--- |----|
| [API de Audience Manager](/help/using/api/rest-api-main/rest-api-main.md) | Estamos en el proceso de [migración de todas nuestras API](/help/using/api/api-swagger-migration.md) desde la documentación del producto a la API de Swagger. Las dos últimas API que hemos migrado son: <ul><li>[API de modelos algorítmicos](https://bank.demdex.com/portal/swagger/index.html#/Algorithmic_Models_API)</li><li>[API de señales derivadas](https://bank.demdex.com/portal/swagger/index.html#/Derived_Signals_API)</li></ul> |
