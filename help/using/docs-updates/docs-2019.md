...
seo-description: Una lista de la documentación nueva o revisada publicada en 2019 y años anteriores. Includes minor updates to the Audience Manager documentation that might not be covered in the Experience Cloud release notes.
...
| [Ejemplos de facturación de Audience Marketplace](../features/audience-marketplace/marketplace-data-buyers/marketplace-buyer-billing.md#billing-examples) | We added a new example, Case 3, where we detail how billing works for segments with activation and modeling use cases. |
...
| Tema | Descripción |
|--- |----|
| [Destinations Home Page](/help/using/features/destinations/destinations-home.md) | La página de aterrizaje [Destinations](https://bank.demdex.com/portal/destinations/all) tiene un nuevo aspecto. Read this page for information about the new layout. |

## May, 2019 {#aam-may-updates}

| Tema | Descripción |
|--- |----|
| [Audience Manager APIs](/help/using/api/rest-api-main/rest-api-main.md) | We are in the process of migrating all our APIs from the product documentation into Swagger API. [](/help/using/api/api-swagger-migration.md) Las dos últimas API que hemos migrado son: <ul><li>[Algorithmic Models API](https://bank.demdex.com/portal/swagger/index.html#/Algorithmic_Models_API)</li><li>[API de señales derivadas](https://bank.demdex.com/portal/swagger/index.html#/Derived_Signals_API)</li></ul> |
