...
| Tema | Descripción |
|--- |----|
| [Página principal de destinos](/help/using/features/destinations/manage-destinations.md#default-landing-page) | The [Destinations](https://bank.demdex.com/portal/destinations/all) landing page has a new look. Lea esta página para obtener información sobre el nuevo diseño. |

## May, 2019 {#aam-may-updates}

| Tema | Descripción |
|--- |----|
| [API de Audience Manager](/help/using/api/rest-api-main/rest-api-main.md) | We are in the process of [migrating all our APIs](/help/using/api/api-swagger-migration.md) from the product documentation into Swagger API. Las dos últimas API que hemos migrado son: <ul><li>[API algorítmica de modelos](https://bank.demdex.com/portal/swagger/index.html#/Algorithmic_Models_API)</li><li>[API de señales derivadas](https://bank.demdex.com/portal/swagger/index.html#/Derived_Signals_API)</li></ul> |
