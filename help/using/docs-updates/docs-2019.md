...
| Tema | Descripción |
|--- |----|
| [Revisión general de la documentación de privacidad y soporte de la Ley de Privacidad del Consumidor de California (CCPA)](../overview/data-security-and-privacy/data-privacy.md) | La [Ley de Privacidad del Consumidor de California (CCPA)](https://www.caprivacy.org/about), que entrará en vigor el 1 de enero de 2020, proporcionará a los residentes de California nuevos derechos con respecto a su información personal e impondrá responsabilidades de protección de datos a ciertas entidades que realizan negocios en California. <br> <br> Audience Manager le ayuda a cumplir con sus obligaciones según las normativas de privacidad, a través de herramientas de privacidad como  [Adobe Experience Platform Privacy ](https://docs.adobe.com/content/help/es-ES/experience-platform/privacy/home.html) Service para acceder a los datos y eliminar solicitudes. <br><br> Hemos actualizado el proceso actual de  [gestión de ](../overview/data-security-and-privacy/data-privacy-requests.md#opt-out-requests) exclusión para incluir el exclusión de cualquier ID declarado (por ejemplo, el ID de CRM). En caso de exclusión por ID declarado, el ID declarado y el último dispositivo vinculado se exclusión de la recopilación de datos del Audience Manager. Las solicitudes de exclusión ahora también envían solicitudes de dessegmentación a [socios de destino](../overview/data-security-and-privacy/assets/AAM-Partners-October2019.xlsx) que admiten esta función, tanto en lote como en tiempo real. <br><br> Además, hemos rediseñado nuestra documentación sobre seguridad [ de ](../overview/data-security-and-privacy/data-security.md)datos, privacidad [ de ](../overview/data-security-and-privacy/data-privacy.md)datos y  [administración de ](../overview/data-security-and-privacy/data-governance.md) datos para facilitarle la búsqueda de la información necesaria para cumplir con las regulaciones mencionadas. |

## Octubre de 2019 {#aam-october-updates}

| Tema | Descripción |
|--- |----|
| [Recomendaciones inteligentes para datos de Audience Marketplace, con tecnología de Adobe Sensei](../features/segments/trait-recommendations.md) | Con Recommendations de características, cuando genera o edita un segmento en [Generador de segmentos](../features/segments/segment-builder.md), ahora obtiene recomendaciones sobre características adicionales que puede incluir, desde [!UICONTROL Audience Marketplace] fuentes de datos a las que no está suscrito. Añada las características recomendadas al segmento para aumentar la audiencia objetivo. <br>  Además, hemos rediseñado la  [!UICONTROL Marketplace] página para que le resulte más fácil encontrar características similares y filtrar fuentes de datos. |
...
| Tema | Descripción |
|--- |----|
| [API de Audience Manager](/help/using/api/rest-api-main/rest-api-main.md) | Estamos en proceso de [migrar todas nuestras API](/help/using/api/api-swagger-migration.md) desde la documentación del producto a la API Swagger. Las dos últimas API que hemos migrado son: <ul><li>[API de modelos algorítmicos](https://bank.demdex.com/portal/swagger/index.html#/Algorithmic_Models_API)</li><li>[API de señales derivadas](https://bank.demdex.com/portal/swagger/index.html#/Derived_Signals_API)</li></ul> |
