...
| Tema | Descripción |
|--- |----|
| [Revisión de la documentación de privacidad y soporte de la Ley de privacidad del consumidor de California (CCPA)](../overview/data-security-and-privacy/data-privacy.md) | La [Ley de Privacidad del Consumidor de California (CCPA)](https://www.caprivacy.org/about), que entrará en vigencia el 1 de enero de 2020, otorgará a los residentes de California nuevos derechos con respecto a su información personal e impondrá responsabilidades de protección de datos a ciertas entidades que operen en California. <br> <br> Audience Manager le ayuda a cumplir con sus obligaciones según las regulaciones de privacidad, a través de herramientas de privacidad como [Adobe Experience Platform Privacy Service](https://docs.adobe.com/content/help/es-ES/experience-platform/privacy/home.html) para solicitudes de acceso y eliminación de datos. <br><br> Hemos actualizado el proceso actual de [administración de exclusión](../overview/data-security-and-privacy/data-privacy-requests.md#opt-out-requests) para incluir la exclusión de cualquier ID declarado (por ejemplo, ID de CRM). En caso de exclusión por ID declarado, el ID declarado y el último dispositivo vinculado se excluirán de la recopilación de datos de Audience Manager. Las solicitudes de exclusión ahora también envían solicitudes de eliminación de la segmentación a [socios de destino](../overview/data-security-and-privacy/assets/AAM-Partners-October2019.xlsx) que admiten esta función, tanto en lote como en tiempo real. <br><br> Además, hemos rediseñado nuestra documentación de [Seguridad de datos](../overview/data-security-and-privacy/data-security.md), [Privacidad de datos](../overview/data-security-and-privacy/data-privacy.md) y [Gobernanza de datos](../overview/data-security-and-privacy/data-governance.md), para facilitarle la búsqueda de la información necesaria para cumplir con las regulaciones mencionadas. |

## Octubre de 2019 {#aam-october-updates}

| Tema | Descripción |
|--- |----|
| Recomendaciones inteligentes para datos de Audience Marketplace, con tecnología de Adobe Sensei | Con Recomendaciones de características, cuando crea o edita un segmento en [Generador de segmentos](../features/segments/segment-builder.md), ahora obtiene recomendaciones sobre características adicionales que puede incluir, desde [!UICONTROL Audience Marketplace] fuentes de datos a las que no está suscrito. Añada las características recomendadas al segmento para aumentar la audiencia objetivo. <br>  Además, hemos rediseñado la página [!UICONTROL Marketplace] para que le resulte más fácil encontrar características similares y filtrar fuentes de datos. |
...
| <ul><li>[Generador de segmentos](/help/using/features/segments/segment-builder.md)</li><li>[Informes de nivel de segmento en Audience Marketplace](/help/using/features/audience-marketplace/marketplace-data-buyers/marketplace-buyer-billing.md)</li><li>[Informes de identidad de audiencia en la vista Resumen de características](/help/using/features/traits/trait-details-page.md)</li><li>[Informes de identidad de audiencia en la vista Resumen de segmentos](/help/using/features/segments/segment-summary-view.md)</li><li>[Cómo crear características de conversión](/help/using/features/traits/create-onboarded-rule-based-traits.md)</li><li>Recomendaciones de rasgos</li></ul> | Hemos añadido vídeos de tutoriales a varias páginas en la documentación de Audience Manager. |

## Agosto de 2019 {#aam-august-updates}

| Tema | Descripción |
|--- |----|
| [Destinos basados en personas](../features/destinations/people-based-destinations-overview.md) | People-Based Destinations es un complemento de pago de Audience Manager que ayuda a activar segmentos de audiencia propios en entornos basados en personas, como Facebook, usando identificadores hash, como direcciones de correo electrónico. |
| [Configuración de las audiencias personalizadas de Twitter como destino de autoservicio basado en dispositivos](../features/destinations/twitter-tailored-audiences.md) | Estamos migrando destinos de Twitter a un modelo de configuración de autoservicio. Este artículo explica lo que necesita hacer para que las integraciones de Twitter existentes sigan funcionando después de la migración. |
