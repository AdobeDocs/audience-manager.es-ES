...
| [Configuración de audiencias personalizadas de Twitter como un destino basado en dispositivos de autoservicio](../features/destinations/twitter-tailored-audiences.md) | Estamos migrando destinos de Twitter a un modelo de configuración de autoservicio. Este artículo explica lo que debe hacer para que las integraciones de Twitter existentes sigan funcionando después de la migración. |
