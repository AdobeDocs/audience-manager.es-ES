...
| [Límites de uso](/help/using/features/administration/usage-limits.md) | Hemos actualizado la forma en que el Audience Manager trata el límite de los modelos algorítmicos. Audience Manager ahora solo cuenta *modelos algorítmicos activos* con respecto al límite. |
