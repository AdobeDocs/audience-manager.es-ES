...
<table id="table_6AAE9EF4DE76467FAFEDAB418B5A0207"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Para fines de referencia, hemos agregado los atributos reservados <code> d_dst_filter</code> y <code> d_rs</code> a la documentación <code> d_</code> atributos. No se recomienda crear características que usen atributos reservados. El Adobe puede cambiar los atributos reservados en cualquier momento. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_18C3AA0411CC4CBC98531BE735934E30"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../api/dcs-intro/dcs-api-reference/dcs-keys.md"> Atributos admitidos para llamadas a la API DCS</a> </p> </td> 
   <td colname="col2"> <p>Se ha añadido <code> d_cts</code> como parámetro opcional en la lista de claves disponibles para solicitudes DCS. Debe ponerse en contacto con su asesor de Adobe Audience Manager o con el Servicio de atención al cliente para habilitarlo. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_8BA284C2CD324D5F988D9209D9078BE1"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Descubra por qué <span class="wintitle"> Archivos de registro procesables</span> es la forma recomendada de importar archivos de registro de DCM a <span class="keyword"> Audience Manager</span> y descubra cómo puede empezar a usar la función. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Se ha añadido el paso 7, sobre lo que debe hacer para habilitar <span class="wintitle"> Archivos de registro procesables</span> después de configurar la importación del archivo de datos DCM en <span class="keyword"> Audience Manager</span>. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_5172A5D65C2841AE8B102B57F00C5FE7"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Se ha revisado con nuevas definiciones que explican cómo <span class="wintitle"> Reglas de combinación de perfiles</span> afectan a los números de los informes. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_C2E33C099A3F4942AA1BCCC5B7B4D05E"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> La variable <b><span class="uicontrol"> Editar</span></b> el flujo de trabajo le permite cambiar la fuente de datos para rasgos de carpeta. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../features/segments/segment-builder-data.md"> Datos de tamaño de segmentos y rasgos en el Generador de segmentos</a> </p> </td> 
   <td colname="col2"> <p>Se ha cambiado una métrica a <span class="wintitle"> Población total de rasgos</span> from <span class="wintitle"> Realizaciones de rasgos únicas</span>. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_FB58595763214BB5BBC778733FF0778C"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Una nueva sección de nuestra documentación, que destaca varios casos de uso para la variable <span class="wintitle"> Audience Lab</span> función. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Puede utilizar varios tipos y fuentes diferentes de modelos en <span class="keyword"> Audience Manager</span>. <span class="wintitle"> Audience Lab</span> ofrece una manera sencilla de comparar las tasas de conversión de sus clientes en todos sus modelos activos. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Uso <span class="wintitle"> Audience Lab</span> para medir el número de conversiones que un creativo está generando entre diferentes destinos. Este caso de uso también le permite medir las conversiones del elemento creativo frente a conversiones naturales. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Se ha añadido una nueva pregunta frecuente para ayudar a responder a las preguntas frecuentes <span class="wintitle"> Regla de combinación de perfiles</span> y preguntas de gráficos de dispositivos. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_9D6D2244D23648F9AC4D1F5E40BDCF14"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Las llamadas de respuestas HTTP DCS ahora contienen la variable <code> tid</code> campo . Utilice este campo para la depuración en caso de incidentes. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2" morerows="2"> <p>Se agregó una nota que aclara que los periodos retrospectivos de 7 y 30 días solo están disponibles para el domingo <b><span class="uicontrol"> Hasta la fecha</span></b> fechas. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Se ha revisado el contenido para indicar lo siguiente: </p> 
    <ul id="ul_99C2ACF7B28F442B8F66A40525F1CAE3"> 
     ...
     <li id="li_5012C420AC544B858246598575E59D8C">Antes de la carga, los archivos deben tener Gzip comprimido y un <code> .gz</code> extensión de archivo. </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../features/segments/segment-builder-data.md"> Datos de tamaño de segmentos y rasgos en el Generador de segmentos</a> </p> </td> 
...
<table id="table_237E64BBFEF84A8E97EE61E6CD5F371F"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Se han agregado más funciones de búsqueda y filtro a la variable <b><span class="uicontrol"> Examinar todas las características</span></b> búsqueda avanzada. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Esta sección contiene contenido nuevo y revisado para respaldar el <span class="wintitle"> Vínculo de perfil</span> y opciones de gráfico de dispositivos de terceros. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_020B4F263E1C4C55BDF10B15436B0471"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2">Se ha agregado un elemento de nombre de archivo opcional <code> PID-ALIAS</code> en el archivo saliente. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Se ha revisado la descripción y se han agregado vínculos relacionados al <code> containerSNID</code> propiedad de <code> DIL.create</code>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../features/addressable-audiences.md#addressable-audience-metrics"> Métricas de audiencia a la que se puede dirigir</a> </p> </td> 
...
<table id="table_8D727AAADA224AF687E41C26CBFB1CC2"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Se ha añadido una nueva entrada que describe la variable <span class="keyword"> Experience Cloud</span> <span class="wintitle"> ID de organización</span>, incluida información sobre cómo encontrarla. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> 
   ...
   <td colname="col2"> <p>Se ha actualizado para incluir la variable <code> DPUUIDS</code> macro. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
Vínculos a [!DNL Audience Manager] notas de la versión y cambios en la documentación. Para un archivo de cambios más antiguos en la [!DNL Experience Cloud] consulte [Notas de la versión anterior](https://experienceleague.adobe.com/docs/release-notes/experience-cloud/current.html) para obtener más información.
