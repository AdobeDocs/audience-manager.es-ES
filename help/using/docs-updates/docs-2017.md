...
<table id="table_6AAE9EF4DE76467FAFEDAB418B5A0207"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Para fines de referencia, agregamos los atributos reservados <code> d_dst_filter</code> y <code> d_rs</code> a los atributos documentados <code> d_</code>. Se recomienda no crear rasgos que utilicen atributos reservados. Adobe puede cambiar los atributos reservados en cualquier momento. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_18C3AA0411CC4CBC98531BE735934E30"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Se ha cambiado el nombre de Total de activaciones de rasgos a Total de realizaciones de rasgos en la interfaz de usuario de Audience Manager. Hemos actualizado las preguntas frecuentes para reflejar esta modificación. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_8BA284C2CD324D5F988D9209D9078BE1"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Averigüe por qué <span class="wintitle"> archivos de registro procesables</span> es la forma recomendada de importar archivos de registro DCM en <span class="keyword"> Audience Manager</span> y descubra cómo puede empezar a utilizar la característica. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_FB58595763214BB5BBC778733FF0778C"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Puede usar varios tipos y fuentes diferentes de modelos en <span class="keyword"> Audience Manager</span>. <span class="wintitle"> Audience Lab</span> es una manera sencilla de comparar las tasas de conversión de los clientes entre los modelos activos. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_9D6D2244D23648F9AC4D1F5E40BDCF14"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../integration/sending-audience-data/batch-data-transfer-explained/batch-data-transfer-overview.md"> Enviar datos por lotes a la Información general de Audience Manager</a> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Se ha agregado un nuevo documento sobre por qué <span class="keyword"> Audience Manager</span> realiza llamadas al dominio <code> demdex.net</code>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="https://experienceleague.adobe.com/docs/core-services/interface/ec-cookies/cookies-am.html" format="https" scope="external"> cookies de Audience Manager</a> </p> </td> 
...
<table id="table_237E64BBFEF84A8E97EE61E6CD5F371F"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p><a href="../api/dcs-intro/dcs-api-reference/dcs-keys.md"> Atributos admitidos para llamadas a la API DCS</a> </p> </td> 
   <td colname="col2"> <p>Se han actualizado los prefijos de variables clave con <code> _p</code>, que identifican parámetros privados en Audience Manager. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_020B4F263E1C4C55BDF10B15436B0471"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="https://experienceleague.adobe.com/docs/core-services/interface/more-resources/dns-prefetch.html" format="https" scope="external"> usando la precarga de DNS con diferentes soluciones de Experience Cloud</a> </p> </td> 
...
<table id="table_8D727AAADA224AF687E41C26CBFB1CC2"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Se ha actualizado con el formato esperado para los identificadores de dispositivo móvil (DAID) administrados por <span class="keyword"> Audience Manager</span>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Se ha agregado una nueva entrada que describe el ID de organización <span class="keyword"> de </span> Experience Cloud<span class="wintitle"> </span>, incluida información sobre cómo encontrarlo. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> 
...
Vínculos a [!DNL Audience Manager] notas de la versión y cambios en la documentación. Para obtener un archivo de cambios anteriores en el nivel [!DNL Experience Cloud], consulte la sección [Notas de la versión anterior](https://experienceleague.adobe.com/docs/release-notes/experience-cloud/current.html).
