...
| Tema | Descripción |
|---- |----|
| [Complemento de Audience Manager para IAB TCF ](../overview/data-security-and-privacy/aam-iab-plugin.md) | Continuando con el enfoque de Adobe en Privacidad por diseño, estamos actualizando el complemento Administrador de Audiencias para IAB TCF a la versión 2.0 de IAB Transparency &amp; Consent Framework (TCF), a partir del 10 de junio de 2020. Los clientes que hayan implementado el complemento Administrador de Audiencias para IAB TCF deben actualizar a la versión 2.0 antes del 15 de agosto de 2020 para poder seguir usando la función. A partir del 15 de agosto de 2020, la versión 1.1 dejará de ser compatible. |
