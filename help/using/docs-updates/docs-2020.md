...
| Tema | Descripción |
|---- |----|
| [Predictive Audiences](../features/algorithmic-models/predictive-audiences.md) | [!UICONTROL Predictive Audiences] le ayuda a clasificar una audiencia desconocida en personalidades distintas, en tiempo real, mediante técnicas avanzadas de ciencia de datos. <br><br> En un contexto de marketing, una persona es un segmento de audiencia definido por visitantes, usuarios o compradores potenciales, que comparten un conjunto específico de características, como su demografía, hábitos de navegación, historial de compras, etc.<br><br>[!UICONTROL Predictive Audiences] modelos llevan este concepto un paso más allá, ya que le permiten utilizar las capacidades de aprendizaje automático de Audience Manager para clasificar audiencias desconocidas en personas distintas. <br><br>Audience Manager le ayuda a conseguirlo calculando la propensión de la audiencia de origen desconocida para un conjunto de audiencias de origen conocidas. |
| Mejoras de [!UICONTROL Profile Merge Rules] adicionales | [!UICONTROL Profile Merge Rules] permite a los clientes de Audience Manager definir, administrar y activar segmentos de audiencia basados en identidad en lugar de en dispositivos. <br><br> A partir del 29 de abril, los clientes de Audience Manager entenderán mejor el desglose de las poblaciones de ID de dispositivos y entre dispositivos para rasgos y segmentos tanto dentro de la segmentación individual como del sistema de informes masivo en la interfaz de usuario de Audience Manager. <br><br> Esto permite obtener una mejor perspectiva de la identidad dentro de Audience Manager, lo que proporciona a los clientes una vista integral de la población total de segmentos por dispositivo, persona y unidad familiar. Las exportaciones masivas de características de los identificadores entre dispositivos y dispositivos también se actualizarán para reflejar estas mejoras.<br><br>  Las actualizaciones específicas permiten: <ul><li>Crear informes con [ID entre dispositivos](../reference/ids-in-aam.md) en los informes [General](../reporting/general-reports.md) y de [Tendencia](../reporting/trend-reports.md).</li><li>Mejorar el [!UICONTROL Trait Selector] en el [Generador de segmentos](../features/segments/segment-builder.md) para incluir las poblaciones de rasgos marcadas por [ID de CRM](../reference/ids-in-aam.md).</li><li>Crear exportaciones de rasgos precisas marcadas por [ID entre dispositivos](../reference/ids-in-aam.md).</li><li>Crear exportaciones de rasgos precisas marcadas por [ID de dispositivo](../reference/ids-in-aam.md) (debe excluir los rasgos autenticados).</li><li>Devolver los recuentos correctos de los rasgos asociados a los [ID de CRM](../reference/ids-in-aam.md) cuando se solicita mediante la herramienta [BAAAM](../reference/bulk-management-tools/bulk-management-intro.md).</li></ul> |
