...
| [Informes de superposición](/help/using/reporting/dynamic-reports/dynamic-reports.md) | Hemos actualizado la metodología que usamos para calcular los informes de superposición ([características](/help/using/reporting/dynamic-reports/trait-trait-overlap-report.md), [segmento a característica](/help/using/reporting/dynamic-reports/segment-trait-overlap-report.md), [segmento a segmento](/help/using/reporting/dynamic-reports/segment-segment-overlap-report.md)). El cálculo de los informes de superposición ahora se basa en las firmas únicas y MinHash de los informes (en lugar de [1/54 muestreo de datos](/help/using/reporting/report-sampling.md#data-sampling-ratio)). |
...
| Tema | Descripción |
|---- |----|
| [Coincidencia de clientes de Google para destinos basados en personas](../features/destinations/people-based-destinations-prerequisites.md#gcm) | Ahora puede utilizar [!UICONTROL People-Based Destinations] para dirigirse a los usuarios a través de [!DNL Google Customer Match]. Antes de poder utilizar [!UICONTROL People-Based Destinations] para enviar los segmentos de audiencia de origen a un destino [!DNL Google Customer Match], es obligatorio que [!DNL Google] lo añada a su lista de permitidos. Consulte la documentación [People-Based Destinations](../features/destinations/people-based-destinations-prerequisites.md#gcm) para obtener más información. |
| [Nuevos servidores SFTP](../faq/faq-data-collection.md) | Ahora puede usar los nuevos servidores [!DNL SFTP] ([!DNL ftp-in-gtw] y [!DNL ftp-out-gtw]) que usan [!DNL AWS SFTP Gateway] sobre [!DNL S3]. |
...
| Tema | Descripción |
|---- |----|
| [Uso compartido de Audiencias entre Audience Manager y Adobe Experience Platform](/help/using/integration/integration-aep/aam-aep-audience-sharing.md#aep-aam-segment-population-differences) | En la nueva sección, **Comprender las diferencias de población de segmentos entre Audience Manager y Experience Platform**, se describen las posibles razones por las que los números de población pueden variar entre Experience Platform y Audience Manager. |
| [Introducción a las API de REST de Audience Manager](/help/using/api/rest-api-main/aam-api-getting-started.md#jwt) | Hemos agregado una nueva sección, **Autenticación JWT (cuenta de servicio) mediante[!DNL Adobe I/O]**. Consulte esta sección para autenticarse en las API de Audience Manager mediante [!DNL Adobe I/O]. |
