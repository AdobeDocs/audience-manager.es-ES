...
| Tema | Descripción |
|----|----|
| [Predictive Audiences](/help/using/features/algorithmic-models/predictive-audiences.md) | <ul><li>**Clonación del modelo de Predictive Audiences**: Ahora puede clonar modelos existentes y cambiar su configuración según sus necesidades. Leer [Clonación y edición de modelos de Predictive Audience](/help/using/features/algorithmic-models/predictive-audiences.md#clone-predictive-audiences) para obtener más información.</li><li>**Clasificación por lotes de Predictive Audiences**: Además de clasificar visitantes en distintas personalidades en tiempo real, las Audiencias predictivas ahora admiten la clasificación por lotes, lo que le ayuda a clasificar usuarios incorporados y activarlos en destinos por lotes.</li></ul> |
| [Superponer informes](/help/using/reporting/dynamic-reports/dynamic-reports.md) | Hemos actualizado la metodología que usamos para calcular los informes de superposición ([Rasgo a rasgo](/help/using/reporting/dynamic-reports/trait-trait-overlap-report.md), [De segmento a rasgo](/help/using/reporting/dynamic-reports/segment-trait-overlap-report.md), [De segmento a segmento](/help/using/reporting/dynamic-reports/segment-segment-overlap-report.md)). El cálculo de los informes de superposición ahora se basa en las firmas únicas y MinHash del sistema de informes (en lugar de [1/54 muestreo de datos](/help/using/reporting/report-sampling.md#data-sampling-ratio)). |
...
| [Nombres de archivo entrantes S3](/help/using/integration/sending-audience-data/batch-data-transfer-explained/inbound-s3-filenames.md) y [nombres de archivo de FTP entrantes](/help/using/integration/sending-audience-data/batch-data-transfer-explained/inbound-ftp-filenames.md) | Hemos actualizado las definiciones y hemos proporcionado ejemplos para la `DPID` y `DPID_TARGET_DATA_OWNER` campos en la sintaxis del nombre de archivo. |

## Agosto de 2020 {#aam-august-updates}

| Tema | Descripción |
|---- |----|
| [Coincidencia de clientes de Google para destinos basados en personas](../features/destinations/people-based-destinations-prerequisites.md#gcm) | Ahora puede utilizar [!UICONTROL People-Based Destinations] para dirigirse a los usuarios mediante [!DNL Google Customer Match]. Antes de usar [!UICONTROL People-Based Destinations] para enviar los segmentos de audiencia de origen a un [!DNL Google Customer Match] destino, es obligatorio que [!DNL Google] le añade a su lista de permitidos. Compruebe la [People-Based Destinations](../features/destinations/people-based-destinations-prerequisites.md#gcm) documentación para obtener más información. |
| [Nuevos servidores SFTP](../faq/faq-data-collection.md) | Ahora puede utilizar el nuevo [!DNL SFTP] servidores ([!DNL ftp-in-gtw] y [!DNL ftp-out-gtw]) que utilizan [!DNL AWS SFTP Gateway] sobre [!DNL S3]. |
...
| Tema | Descripción |
|---- |----|
| [Uso compartido de Audiencias entre Audience Manager y Adobe Experience Platform](/help/using/integration/integration-aep/aam-aep-audience-sharing.md#aep-aam-segment-population-differences) | La nueva sección, **Comprender las diferencias de población de segmentos entre Audience Manager y Experience Platform**, describe las posibles razones por las que los números de población pueden variar entre el Experience Platform y el Audience Manager. |
| [Introducción a las API de REST de Audience Manager](/help/using/api/rest-api-main/aam-api-getting-started.md#jwt) | Hemos añadido una nueva sección, **Autenticación JWT (cuenta de servicio) mediante[!DNL Adobe I/O]**. Consulte esta sección para autenticarse en las API de Audience Manager mediante [!DNL Adobe I/O]. |
