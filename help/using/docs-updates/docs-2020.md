...
| Tema | Descripción |
|----|----|
| [Predictive Audiences](/help/using/features/algorithmic-models/predictive-audiences.md) | <ul><li>**Clonación** del modelo de Audiencias predictivas: Ahora puede clonar modelos existentes y cambiar su configuración según sus necesidades. Lea [Clonación y edición de modelos](/help/using/features/algorithmic-models/predictive-audiences.md#clone-predictive-audiences) de Audiencia predictivos para obtener más información.</li><li>**Clasificación** por lotes de Audiencias predictivas: Además de clasificar visitantes en distintas personalidades en tiempo real, las Audiencias predictivas ahora admiten la clasificación por lotes, lo que le ayuda a clasificar usuarios incorporados y a activarlos en destinos por lotes.</li></ul> |
| [Informes de superposición](/help/using/reporting/dynamic-reports/dynamic-reports.md) | Hemos actualizado la metodología que usamos para calcular los informes de superposición ([características](/help/using/reporting/dynamic-reports/trait-trait-overlap-report.md), [segmento a característica](/help/using/reporting/dynamic-reports/segment-trait-overlap-report.md), [segmento a segmento](/help/using/reporting/dynamic-reports/segment-segment-overlap-report.md)). El cálculo de los informes de superposición ahora se basa en las firmas únicas y mínHash de sistema de informes (en lugar de [un muestreo](/help/using/reporting/report-sampling.md#data-sampling-ratio)de datos de 1/54). |
...
| [Nombres de archivos](/help/using/integration/sending-audience-data/batch-data-transfer-explained/inbound-s3-filenames.md) S3 entrantes y nombres de archivos FTP [entrantes](/help/using/integration/sending-audience-data/batch-data-transfer-explained/inbound-ftp-filenames.md) | Hemos actualizado las definiciones y proporcionado ejemplos para los campos `DPID` y `DPID_TARGET_DATA_OWNER` en la sintaxis del nombre de archivo. |

## August, 2020 {#aam-august-updates}

| Tema | Descripción |
|---- |----|
| [Coincidencia de clientes de Google para destinos basados en personas](../features/destinations/people-based-destinations-prerequisites.md#gcm) | Ahora puede usar [!UICONTROL People-Based Destinations] para destinatario de usuarios mediante [!DNL Google Customer Match]. Antes de poder usar [!UICONTROL People-Based Destinations] para enviar segmentos de audiencia de origen a un [!DNL Google Customer Match] destino, es obligatorio que [!DNL Google] le añada a su lista de permitidos. Consulte la documentación Destinos [basados en](../features/destinations/people-based-destinations-prerequisites.md#gcm) personas para obtener más información. |
| [Nuevos servidores SFTP](../faq/faq-data-collection.md) | Ahora puede utilizar los nuevos [!DNL SFTP] servidores ([!DNL ftp-in-gtw] y [!DNL ftp-out-gtw]) que utilizan [!DNL AWS SFTP Gateway] sobre [!DNL S3]. |
...
| [Introducción a las API de Audience Manager REST](/help/using/api/rest-api-main/aam-api-getting-started.md#jwt) | Hemos agregado una nueva sección, Autenticación **JWT (cuenta de servicio) mediante[!DNL Adobe I/O]**. Consulte esta sección para autenticarse con las API de Audience Manager mediante [!DNL Adobe I/O]. |
