...
| [Nuevos servidores SFTP](../faq/faq-data-collection.md) | Ahora puede utilizar los nuevos [!DNL SFTP] servidores (`ftp-in-gtw` y `ftp-out-gtw`) que utilizan [!DNL AWS SFTP Gateway] sobre [!DNL S3]. |
