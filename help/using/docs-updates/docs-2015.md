...
<table id="table_AC8FF0DB45B546C69D89749FF0FA1CCD"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <span class="keyword"> El Audience Manager</span> establece un límite máximo en el número de características, segmentos, destinos y modelos algorítmicos que puede crear para una cuenta. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_A3CAA532BFE7440C93BC11DEF5594D65"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Revisiones y actualizaciones de texto. Además, se incluyeron nuevos pares de clave-valor requeridos para utilizar y ver nombres de datos legibles en los informes de publicidad de Analytics <span class="wintitle"></span> . </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_E60674ACBD254365A73AB47FB840A333"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <span class="keyword"> Los clientes de Analytics</span> deben establecer un código de integración al usar el Perfil de marketing principal y pasar los ID declarados a través del servicio de ID de Visitante al <span class="keyword"> Audience Manager</span>. </p> <p>Este documento está en desuso y ha sido reemplazado por <a href="../features/profile-merge-rules/merge-rules-start.md"> Crear una fuente</a>de datos entre dispositivos. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_E8CD8CF9B9D3439C99AC688AFD712621"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Se ha añadido la nota siguiente: </p> <p> <p>Nota:  <span class="keyword"> El Audience Manager</span> no admite archivos .zip para los cubos S3 entrantes. </p> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../faq/faq-reporting.md"> Preguntas más frecuentes sobre la creación de informes </a> </p> </td> 
