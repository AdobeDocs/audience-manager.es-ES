---
description: Una lista de la documentación nueva y revisada del Administrador de Audiencias publicada en 2015. Incluye actualizaciones o cambios menores en la guía del Administrador de Audiencias que podrían no incluirse en las notas de la versión de Experience Cloud.
seo-description: Una lista de la documentación nueva y revisada del Administrador de Audiencias publicada en 2015. Incluye actualizaciones o cambios menores en la guía del Administrador de Audiencias que podrían no incluirse en las notas de la versión de Experience Cloud.
...
Una lista de la documentación nueva y revisada del Administrador de Audiencias publicada en 2015. Incluye actualizaciones o cambios menores en la guía del Administrador de Audiencias que podrían no incluirse en las notas de la versión de Experience Cloud.
...
<table id="table_AC8FF0DB45B546C69D89749FF0FA1CCD"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <span class="keyword"> El Administrador</span> de Audiencias establece un límite máximo en el número de características, segmentos, destinos y modelos algorítmicos que puede crear para una cuenta. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_3A725D1D52D24CEAB49B10814008F1C7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Actualice el código para utilizarlo <code> d_cid</code> o <code> d_cid_ic</code> en lugar de <code> d_dpid</code> y <code> d_dpuuid</code>. Las variables DPID y DPUUID seguirán funcionando, pero debe considerarlas obsoletas. Esto incluye las variantes DPID y DPUUID sin el <code> d_</code> prefijo. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_A3CAA532BFE7440C93BC11DEF5594D65"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Requisitos de formato y contenido para incorporar datos a los informes de Optimización <span class="wintitle"> de</span> Audiencia. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../integration/media-data-integration/click-data-pixels.md"> Captura de datos de clics en Campaña mediante llamadas de píxel </a> </p> </td> 
   <td colname="col2"> <p>Revisiones y actualizaciones de texto. Además, se han incluido nuevos pares de clave-valor necesarios para utilizar y ver nombres de datos legibles en los <span class="wintitle"> informes de análisis</span> de publicidad. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_E60674ACBD254365A73AB47FB840A333"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <span class="keyword"> Los clientes de Analytics</span> deben establecer un código de integración al usar el Perfil de marketing principal y pasar los ID declarados a través del servicio de ID de Visitante al administrador <span class="keyword"> de</span>Audiencias. </p> <p>Este documento está en desuso y ha sido reemplazado por <a href="../features/profile-merge-rules/merge-rules-start.md"> Crear una fuente</a>de datos entre dispositivos. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Se ha actualizado el texto y las imágenes nuevas que explican el funcionamiento de los distintos sistemas del Administrador <span class="keyword"> de</span> Audiencias y el flujo de datos a través de nuestro sistema. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_EA3AF6A1987B4EFDBC84F265D5F47DC0"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <a href="../reporting/audience-optimization-reports/aor-advertisers/import-dcm.md"> Importación de archivos de datos de DCM en el Administrador de Audiencias</a> </td> 
   <td colname="col2">Incluya<span class="keyword"> los datos del Administrador</span> de Campañas de DoubleClick en el Administrador <span class="keyword"> de</span>Audiencias. </td> 
  </tr> 
  <tr> 
...
<table id="table_E8CD8CF9B9D3439C99AC688AFD712621"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Se ha añadido la nota siguiente: </p> <p> <p>Nota:  <span class="keyword"> El Administrador</span> de Audiencias no admite archivos .zip para los bloques S3 entrantes. </p> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../faq/faq-reporting.md"> Preguntas más frecuentes sobre la creación de informes </a> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Se Añadió la siguiente información en la sección Limitaciones y reglas: </p> <p> 
     <ul id="ul_2451A3EAA05E4961AA7EA90026F353F5"> 
      ...
      <li id="li_F957554820B6454FA9756267C4D09AAD"> <p>Si necesita que los requisitos de actualización y frecuencia sean inferiores a un número específico de veces o días, debe unir esa característica a otra con un operador Y. </p> <p>Con el ejemplo anterior, <code> frequency([1000T]) &lt;= 5</code>, la expresión pasa a ser válida cuando se une con otra característica. </p> <p>Por ejemplo: </p> <p> <code> frequency([1000T]) &lt;= 5 AND isSiteVisitorTrait</code> </p> </li> 
      <li id="li_BAEC874C0B6E4232A83C7228E84A7AD0"> <p>En los casos de uso de límite de frecuencia de publicidad, puede crear una regla de segmento similar a la siguiente: </p> <p> <code> (frequency([1000T] &lt;= 2D) &gt;= 5)?</code> </p> <p>Esta expresión incluye a todos los usuarios que han realizado la característica con la ID "1000" en los últimos 2 días más de cinco veces. </p> <p>Puede lograr el límite enviando este segmento al servidor de publicidad y luego incluir un NO en el segmento en el servidor de publicidad. Este enfoque logra un bueno rendimiento en el Administrador de Audiencias, mientras que sigue siendo el mismo objetivo para el límite de frecuencia. </p> </li> 
     </ul> </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_A52FC2668EEE4100A71B52267B7215F9"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Sección Añadida que explica cómo se generan los números en los informes <span class="wintitle"></span> generales. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p>Habilitación del cliente de combinación de Perfiles </p> </td> 
   <td colname="col2"> <p>Se Añadió un paso adicional para explicar cómo agregar el uso de ID declarados a DIL y al SDK de Mobile. </p> <p>Este documento ha quedado obsoleto y se ha sustituido por <a href="../features/profile-merge-rules/merge-rules-start.md"> Crear una fuente</a>de datos entre dispositivos. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../integration/sending-audience-data/batch-data-transfer-explained/inbound-file-contents.md"> Contenido del archivo de datos de entrada: Sintaxis, variables y ejemplos </a> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Se ha actualizado el texto y se han añadido ilustraciones. </p> <p>Este documento ha quedado obsoleto y ha sido reemplazado por <a href="../features/profile-merge-rules/merge-rules-overview.md"> Perfil Link</a>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../features/segments/recency-and-frequency.md"> Actualización y frecuencia </a> </p> </td> 
