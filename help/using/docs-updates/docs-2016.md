...
<table id="table_D16570793032445FBC18F662BF9DDA7A"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Incluye una nueva entrada sobre las direcciones IP y FTP de <span class="keyword"> Audience Manager</span> con listas blancas. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_D83514BA7F5745DA80D6135804D5BD5F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <span class="keyword"> Audiencia </span> Manager gestiona los estados de autenticación de ID de visitante  <code> UNKNOWN</code> y  <code> LOGGED_OUT</code> del mismo modo. El documento proporciona más información sobre cómo manejamos <code> setCustomerID</code> llamadas de evento. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Preguntas más frecuentes sobre la función <span class="wintitle"> Laboratorio de Audiencia</span>. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Nuevo contenido que describe cómo funcionan los intervalos de tiempo para <span class="wintitle"> Destinos direccionables</span> y <span class="wintitle"> Destinos</span>. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_B19586DBA5D44F8E9D06610DB704EFB9"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2">Añadió la capacidad de asegurar la transferencia de datos salientes en tiempo real mediante el protocolo OAuth 2.0. Póngase en contacto con su <span class="keyword"> asesor de Adobe Audience Manager</span> para empezar. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Revisado para observar que <code> GA.init()</code> no funciona con la última versión del código de análisis de Google, <code> analytics.js</code>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Se ha revisado para incluir más información sobre la cooperación <span class="keyword"> entre dispositivos de Adobe Experience Cloud</span>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_9B18916DD43E4DB38C0C340DE4E3DF62"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2">Información general sobre la <span class="wintitle"> Biblioteca de información de datos</span> (DIL). </td> 
  </tr> 
  <tr> 
...
<table id="table_50CD90671E4B4C50A624AC0948FA8324"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Controlar cómo hace el DIL las llamadas de recopilación de datos con HTTP o HTTPS. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../faq/faq-api.md"> Preguntas frecuentes sobre API </a> </p> </td> 
   <td colname="col2"> <p>Se ha actualizado el contenido que explica por qué DIL utiliza métodos <code> GET</code> y <code> POST</code> para enviar datos en una llamada de evento. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_183F245818BC4CF5AAB9B610C1BE4A9F"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Se han actualizado los <span class="wintitle"> informes de Audience Optimization</span>con conversión entre Canales, Control de acceso basado en roles, grupos de conversión y el informe de características de conversión de informes. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>La opción <span class="wintitle"> Conversión entre Canales</span> de los informes <span class="wintitle"> Audience Optimization</span> permite atribuir conversiones sin conexión a impresiones o clics en línea servidos. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_D4EE56B5AE23497F98025E1D13CBB3A1"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Se añadió un nuevo operador con nombre, <code> Matcheswords</code>. Permite especificar patrones de palabras coincidentes sin usar una expresión normal. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_BF1B40564C3C4B569A3B2504ACEEE0E4"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../features/audience-marketplace/marketplace-data-buyers/marketplace-manage-subscriptions.md"> Qué sucede después de que un proveedor desactiva mi fuente de datos </a> </p> </td> 
   <td colname="col2"> <p>Describe lo que puede esperar un Audience Marketplace de datos <span class="wintitle"></span> si un proveedor anula el acceso a una fuente de datos. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../api/dcs-intro/dcs-api-reference/dcs-error-codes.md"> Códigos de error DCS, mensajes y ejemplos </a> </p> </td> 
...
<table id="table_AC8FF0DB45B546C69D89749FF0FA1CCD"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Nueva documentación que lista y define los elementos en un informe de facturación <span class="wintitle"> Audience Marketplace</span>. </p> </td> 
  </tr> 
  <tr> 
