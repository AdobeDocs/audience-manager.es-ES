...
<table id="table_D16570793032445FBC18F662BF9DDA7A"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Después de una actualización de Google en mayo de 2016, puede cargar el código de DIL en la sección de HTML personalizado de una etiqueta. Ya no es necesario que aloje el código de forma remota. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Incluye una nueva entrada sobre listas blancas <span class="keyword"> Audience Manager</span> Direcciones IP y FTP. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Documentación que describe un nuevo método de DIL que permite enviar datos a <span class="keyword"> Audience Manager</span> de Google Universal Analytics. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_D83514BA7F5745DA80D6135804D5BD5F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <span class="keyword"> Audience Manager</span> gestiona los estados de autenticación de ID de visitante <code> UNKNOWN</code> y <code> LOGGED_OUT</code> de la misma manera. El documento proporciona más información sobre cómo manejamos <code> setCustomerID</code> llamadas de evento. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Preguntas frecuentes sobre <span class="wintitle"> Audience Lab</span> función. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Nuevo contenido que describe cómo funcionan los intervalos de tiempo <span class="wintitle"> Audiencias a las que se puede dirigir</span> y <span class="wintitle"> Destinos</span>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Nuevo contenido que describe características de <span class="wintitle"> Destinos</span> página de aterrizaje. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_B19586DBA5D44F8E9D06610DB704EFB9"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2">Se ha agregado la capacidad de proteger la transferencia de datos salientes en tiempo real mediante el protocolo OAuth 2.0. Póngase en contacto con su <span class="keyword"> Adobe Audience Manager</span> para empezar. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Revisado para señalar que <code> GA.init()</code> no funciona con la última versión del código de análisis de Google, <code> analytics.js</code>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <i>Esta función se ha desaprobado.</i><p>Se ha revisado para incluir más información sobre la variable <span class="keyword"> Cooperación entre dispositivos de Adobe Experience Cloud</span>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_9B18916DD43E4DB38C0C340DE4E3DF62"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2">Una visión general del <span class="wintitle"> Biblioteca de información de datos</span> (DIL). </td> 
  </tr> 
  <tr> 
...
<table id="table_50CD90671E4B4C50A624AC0948FA8324"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Contenido actualizado que explica por qué utiliza DIL <code> GET</code> y <code> POST</code> métodos para enviar datos en una llamada de evento. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_183F245818BC4CF5AAB9B610C1BE4A9F"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>La variable <span class="wintitle"> Conversión en todos los canales</span> en la <span class="wintitle"> Audience Optimization</span> los informes permiten atribuir conversiones sin conexión a impresiones o clics en línea. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_E71252DF328F42A3AB0BD2CA7DC5A549"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Eliminado de <span class="keyword"> Audience Manager</span> documentación de en septiembre de 2017. Se ha movido a <span class="keyword"> Analytics</span> documentación. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_D4EE56B5AE23497F98025E1D13CBB3A1"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Se ha añadido un operador con nombre nuevo, <code> Matcheswords</code>. Permite especificar patrones de palabra coincidentes sin utilizar una expresión regular. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_BF1B40564C3C4B569A3B2504ACEEE0E4"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../features/audience-marketplace/marketplace-data-buyers/marketplace-manage-subscriptions.md"> Qué sucede después de que un proveedor desactiva mi fuente de datos </a> </p> </td> 
   <td colname="col2"> <p>Describe lo que <span class="wintitle"> Audience Marketplace</span> el comprador de datos puede esperar si un proveedor revoca el acceso a una fuente de datos. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../api/dcs-intro/dcs-api-reference/dcs-error-codes.md"> Códigos de error DCS, mensajes y ejemplos </a> </p> </td> 
...
<table id="table_AC8FF0DB45B546C69D89749FF0FA1CCD"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../integration/media-data-integration/impression-data-pixels.md"> Captura de los datos de impresión de campaña a través de Pixel Calls </a> </p> </td> 
   <td colname="col2"> <p>Se han añadido nuevas entradas de clave y macro para <code> d_mid</code> y <code> d_region</code>. </p> </td> 
  </tr> 
  <tr> 
