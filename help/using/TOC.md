...
+ Funciones{#features}
  ...
  + Segmentos{#segments}
    ...
    + [Referencia de calificación de rasgos y segmentos](https://experienceleague.adobe.com/docs/audience-manager/user-guide/features/traits/trait-and-segment-qualification-reference.html)
...
+ Guías de implementación e integración{#implementation-integration-guides}
  ...
  + Integración con otras aplicaciones de Experience Cloud {#integration-other-solutions}
    ...
    + [Publicación de un segmento de Adobe Analytics en Experience Cloud (abre la documentación de Adobe Analytics)](https://experienceleague.adobe.com/docs/core-services/interface/audiences/t-publish-audience-segment.html)
