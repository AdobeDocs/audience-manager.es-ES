---
description: Audience Manager requiere que las solicitudes HTTP(S) de servidor a servidor se firmen digitalmente para su validez. Este documento describe cómo puede firmar solicitudes HTTP con claves privadas.
...
Audience Manager requiere que las `HTTP(S)` solicitudes de servidor a servidor se firmen digitalmente para su validez. Este documento describe cómo puede firmar `HTTP(S)` solicitudes con claves privadas.
