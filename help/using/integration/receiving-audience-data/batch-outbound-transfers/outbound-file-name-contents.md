...
>[!NOTE]
>
>The style elements (`monospaced text`, *italics*, brackets `[ ]` `( )`, etc.) en este documento indican elementos y opciones de código. Consulte [Convenciones de estilo para elementos de código y texto](../../../reference/code-style-elements.md) para obtener más información.

## Syntax and File Name Elements {#syntax-file-name}

Los nombres de archivos salientes contienen los siguientes elementos opcionales y requeridos:
...
<table id="table_1EA97D75004148CE85F702427DB7E97A"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>El modo de sincronización es un marcador de posición de macro que agrega una etiqueta al nombre del archivo en función del tipo de sincronización. Los tipos de sincronización son completos e incrementales. They'll appear in the file name as <code> iter </code> or <code> full </code>. </p> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Un entero. Identifica parte de un archivo que se divide en varias partes para mejorar los tiempos de procesamiento. El número indica a qué parte del archivo original pertenece los datos. </p> <p>El archivo original no tendrá ningún número dividido. El primer archivo dividido comenzará con 1. Consulte los ejemplos siguientes. </p> </td> 
  </tr> 
  <tr> 
...
**Escenario 3**: Archivos enviados a [!DNL FTP] la ubicación, con *`PID-ALIAS="XYZCustomer"`* y con ID de usuario de terceros en el contenido del archivo ( *`Vendor ID=45454`*):
