...
* [Información general sobre el servicio de segmentación](https://experienceleague.adobe.com/docs/experience-platform/segmentation/home.html?lang=es#audiences)
* [Experience Platform Generador de segmentos usuario guía](https://experienceleague.adobe.com/docs/experience-platform/segmentation/ui/overview.html?lang=es#audiences)
...
[[!UICONTROL Profile Merge Rules]](/help/using/features/profile-merge-rules/merge-rules-overview.md) En Audience Manager y [[!UICONTROL Merge Policies]](https://experienceleague.adobe.com/docs/experience-platform/profile/ui/merge-policies.html?lang=es) en Experience Platform funcionan de manera diferente, y el gráfico de identidad utilizado para cada uno varía. Debido a esto, se esperan algunas diferencias entre segmento poblaciones.

>[!NOTE]
>
> Al compartir segmentos de Experience Platform a Audience Manager, el directiva de combinación predeterminado de su organización [Platform](https://experienceleague.adobe.com/docs/experience-platform/profile/merge-policies/overview.html?lang=es#default-merge-policy) tiene prioridad sobre el [directiva de combinación utilizado por el segmento](https://experienceleague.adobe.com/docs/experience-platform/segmentation/ui/segment-builder.html?lang=es#merge-policies) compartido con Audience Manager. Por ejemplo, si el directiva de combinación del segmento compartido permite [la unión](https://experienceleague.adobe.com/docs/experience-platform/profile/merge-policies/ui-guide.html?lang=es#configure) de ID, pero el directiva de combinación predeterminado de la organización no, esto podría dar lugar a diferencias de población entre Platform y Audience Manager.
