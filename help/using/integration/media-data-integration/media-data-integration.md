---
description: Puede capturar datos de campañas de medios usando llamadas en píxeles a Audience Manager (a menudo denominadas pixelar el elemento creativo) o ingeriendo archivos de registro.
...
Puede capturar datos de campañas de medios usando llamadas en píxeles a Audience Manager (a menudo denominadas pixelar el elemento creativo) o ingeriendo archivos de registro. Lea los artículos de esta sección para comprender el proceso.
...
* [Importación De Archivos De Datos De Google Ad Manager En Audience Manager](/help/using/reporting/audience-optimization-reports/aor-publishers/import-dfp.md)
