...
El sistema de informes de errores y el muestreo de errores son dos características distintas del [!UICONTROL Onboarding Status] informe.
...
<table id="table_1D44A2E6B4C847848B818190DD336841"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Lista los archivos que el <span class="keyword"> Audience Manager</span> recibió y procesó desde el origen de datos de entrada seleccionado. </p> <p>El procesamiento de archivos fallará si el nombre del archivo no tiene el formato correcto. Los requisitos de nombre de archivo varían en función de cómo se envíen estos datos al <span class="keyword"> Audience Manager</span>. Los métodos de Envío incluyen <span class="keyword"> Amazon S3</span> y FTP. Para obtener instrucciones sobre cómo asignar nombres a los archivos, consulte: </p> <p> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Lista el número de registros que no se procesaron correctamente porque no coincidían con los requisitos de sintaxis o formato. Consulte Contenido <a href="../integration/sending-audience-data/batch-data-transfer-explained/inbound-file-contents.md"> del archivo de datos de entrada: Sintaxis, variables y ejemplos</a> para obtener información sobre cómo dar formato a los datos. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <b>ID de AAM no válido</b> </p> </td> 
   <td colname="col2"> <p>Lista el número de ID de usuario de <span class="keyword"> Audience Manager</span> con formato incorrecto (UUID). Normalmente, esto indica los ID: </p> 
...
<tr> 
   ...
   <td colname="col2"> <p>Lista el número de ID de dispositivos globales con formato incorrecto. Consulte <a href="../reference/ids-in-aam.md">Índice de ID en fuentes</a> de datos globales y de Audience Manager <a href="../features/global-data-sources.md"></a> para obtener detalles sobre cómo se debe dar formato a los ID de dispositivo y qué fuentes de datos globales debe utilizar, según el tipo de dispositivo.</p>
...
<tr> 
   ...
   <td colname="col2"> <p>Son ID incorporados <span class="keyword"> que el Audience Manager</span> no puede coincidir con un ID existente. Los ID integrados pueden tener este estado cuando el <span class="keyword"> Audience Manager</span> aún no ha realizado una sincronización de ID o aún no puede coincidir con el ID incluso después de una sincronización. </p> <p>En el caso de los ID móviles no coincidentes, <span class="keyword"> el Audience Manager</span> : </p> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Características de Listas que <span class="keyword"> el Audience Manager</span> no puede coincidir con una característica integrada. Esto podría deberse a: </p> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Número de registros almacenados correctamente. Debido a errores de formato de archivo, es posible que algunos de los registros recibidos no sean almacenados por el <span class="keyword"> Audience Manager</span>. El número de registros almacenados puede ser menor que el número de registros recibidos. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <b>Características totales realizadas</b> </p> </td> 
   <td colname="col2"> <p>Número de características de todos los usuarios en todos los archivos de entrada que se almacenan en la plataforma de <span class="keyword"> Audience Manager</span> . </p> </td> 
  </tr> 
  <tr> 
