...
En la tabla siguiente se describen las convenciones de nomenclatura de archivos y las extensiones de archivo utilizadas en un archivo .csv de superposición. In the examples, *italics* indicates a variable placeholder.
...
<table id="table_C99FCABA365B4AB99620F27D4414E623"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Los archivos de informes superpuestos están comprimidos gzip y tienen la extensión de archivo <code> .gz</code> . Debe agregar la extensión <code> .csv</code> al archivo después de la descompresión. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Sintaxis del nombre del archivo: </p> <p> 
     <ul id="ul_D69D320A1AE94361B75D2AB47F90C4D1"> 
      <li id="li_FFB104975D104050AB67FEEC903C6E2E">Archivos de segmento a segmento: ID <code>_<i>aaaa-mm-dd</i>_<i>date de</i>S2S_superposición_<i>socio</i></code> </li> 
      <li id="li_7DEC51D693FB4377840D652AF40386EF">Archivos de segmento a rasgo: <code>S2T_superposición_ID<i>_</i>de socio_<i>aaaa-mm-dd</i>_<i>intervalo de fechas</i></code> </li> 
      <li id="li_CCB35A2BCB714E518AB279D453740623">Archivos de rasgo a rasgo: Intervalo de <code>fecha<i>T2T_superposición_</i>ID<i>_</i>aaaa-mm-dd<i>_dd_mm</i></code> </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Ejemplos de nombres de archivo para un solo informe: </p> <p> 
     <ul id="ul_EED13F73F37D48868236F8945E19C88F"> 
      <li id="li_55DD677F9BA7460AA4AAD27AFD08A5AE">Archivo único de 7 días: <code> S2S_superposición_12345_2017_01_14_70000.gz</code> </li> 
      <li id="li_487F8B76B7F24DCEB890C2D8186728F7">Archivo único de 30 días: <code> S2S_superposición_12345_2017_01_14_30000.gz</code> </li> 
     </ul> </p> <p>Ejemplos de nombres de archivo para un informe con varios archivos: </p> <p> 
     <ul id="ul_D307EECBB3524962AB8C8332BF699D29"> 
      <li id="li_9FA3B5539E5A4F95899075866D96DEA0"> <code> S2S_superposición_12345_2017_01_14_70000.gz</code> </li> 
      <li id="li_D8776BD8BAD842C29119B7765F258384"> <code> S2S_superposición_12345_2017_01_14_70001.gz</code> </li> 
      <li id="li_E97AC7696E954A9DAE3DA4E51B5C1B0E"> <code> S2S_superposición_12345_2017_01_14_70002.gz</code> </li> 
     </ul> </p> </td> 
  </tr> 
 </tbody> 
</table>
...
En el archivo, los datos de cadena se encierran entre comillas dobles. Consulte los datos de la maqueta a continuación. Esto se ha truncado para la brevedad y el ajuste a la pantalla.
...
<table id="table_1BDC7019DF2543069D7AE229C5E2454E"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>ID del segmento de línea base. El segmento de línea de base es el segmento que desea comparar con otros segmentos. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Puede obtener informes para intervalos retrospectivos de 7 y 30 días. El <code> intervalo</code> corresponde a los intervalos de tiempo que se muestran a continuación. </p> <p> 
  ...
  <tr> 
   <td colname="col1"> <p> <code> superponer_únicos</code> </p> </td> 
...
<table id="table_45270B5D01014AD99921B320D3A32DB6"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>ID del proveedor de datos. Los ID incluyen: </p> <p> 
     <ul id="ul_B40EF144552B4BD3A1C2AE2BAFFC5A68"> 
      <li id="li_8E3B524C615F4047A5A06AF2EDF9C758"> <code> 1er origen</code> </li> 
  ...
  <tr> 
   <td colname="col1"> <p> <code> superponer_únicos</code> </p> </td> 
   <td colname="col2"> <p>Número de usuarios únicos compartidos entre los segmentos y características seleccionados. En el informe de la interfaz de usuario, este número aparece en la ventana emergente cuando pasa el ratón sobre una característica en los resultados del mapa de calor. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code> trait_uniques_superposición_perc</code> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p> <code> segment_uniques_superposición_perc</code> </p> </td> 
...
<table id="table_603216E6AFE4439A87C91DDFF2989F53"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p> <code> superponer_rasit_id</code> </p> </td> 
   <td colname="col2"> <p>ID de la característica que está comparando con la característica básica. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code> superponer_nombre_rasgo</code> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>ID del proveedor de datos. Los ID incluyen: </p> <p> 
     <ul id="ul_FB6FCAF484BE404B8987B54078F5E858"> 
      <li id="li_5E473205AB494D199FBDF22CAA4A1C57"> <code> 1er origen</code> </li> 
  ...
  <tr> 
   <td colname="col1"> <p> <code> superposición_características_únicas</code> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Número de usuarios únicos en una característica base. En el informe de la interfaz de usuario, este número aparece en la ventana emergente cuando pasa el ratón sobre una característica en los resultados del mapa de calor. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code> superponer_únicos</code> </p> </td> 
   <td colname="col2"> <p>El número de usuarios únicos compartidos entre las características seleccionadas. En el informe de la interfaz de usuario, este número aparece en la ventana emergente cuando pasa el ratón sobre una característica en los resultados del mapa de calor. </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p> <code> superposición_características_únicas_superposición_perc</code> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p> <code> base_trait_uniques_superposición_perc</code> </p> </td> 
   <td colname="col2"> <p>% de usuarios únicos que se superponen entre las características seleccionadas. En el informe de la interfaz de usuario, este número aparece en la ventana emergente cuando pasa el ratón sobre una característica en los resultados del mapa de calor. </p> </td> 
  </tr> 
 </tbody> 
</table>
