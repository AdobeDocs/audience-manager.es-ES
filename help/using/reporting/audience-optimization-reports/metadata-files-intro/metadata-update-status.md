...
El directorio de estado S3 contiene un `.info` archivo con información de éxito y error sobre los archivos cargados. El archivo contiene datos con formato JSON con resultados de estado en una matriz.

El contenido del `.info` archivo será similar al de este ejemplo.
...
Las siguientes tablas enumeran y definen las claves de las secciones `Files` y `Summary` de un archivo de estado de metadatos.
...
<table id="table_BF23C032FEFA446282E9364E85BE8C9F"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Suma de comprobación MD 5 para el archivo de metadatos cargado en el <code> directorio meta</code> . </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code> NombreDeArchivo</code> </p> </td> 
   <td colname="col2"> <p>Nombre del archivo de metadatos cargado en el <code> directorio meta</code> . </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Devuelve 2 valores de texto que describen el estado de procesamiento del archivo de metadatos: </p> 
    <ul id="ul_3814EBB6B42B4EB294B1ABA5782190B6"> 
     <li id="li_92AAECE7E9A44B1193A1D93ABBCE46B0"> <code> ÉXITO</code> </li> 
...
<table id="table_C765A0CDBAA14A2FB5E0D38BDD1D292A"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Fecha de procesamiento del archivo en formato <code><i>aaaa-mm-dd</i></code> . </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Devuelve 2 valores de texto que describen el estado de procesamiento de todos los archivos durante un día entero: </p> 
    <ul id="ul_3FC092CA043A486C9C79FECF71FAF8FB"> 
     <li id="li_754B32D8267D44BBBD6EC354C459C566"> <code> ÉXITO</code> </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Devuelve una marca de hora legible en lenguaje natural para las horas de inicio de procesamiento. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code> ProcessingTimePOSIX</code> </p> </td> 
   <td colname="col2"> <p>Marca de hora UNIX para procesar las horas de inicio. </p> </td> 
  </tr> 
  <tr> 
