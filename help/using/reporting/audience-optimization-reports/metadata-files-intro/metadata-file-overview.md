...
![esquema de evento de archivos de metadatos](assets/metadata-file-event.png)
...
![esquema del nombre del archivo de metadatos](assets/metadata-file-name.png)
...
![esquema del contenido del archivo de metadatos](assets/metadata-file-contents.png)
